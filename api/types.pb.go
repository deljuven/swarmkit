...
type ImageDependency struct {
	ReplicaDescriptor uint64 `protobuf:"varint,1,opt,name=replica_descriptor,json=replicaDescriptor,proto3" json:"replica_descriptor,omitempty"`
}

func (m *ImageDependency) Reset()                    { *m = ImageDependency{} }
func (*ImageDependency) ProtoMessage()               {}
func (*ImageDependency) Descriptor() ([]byte, []int) { return fileDescriptorTypes, []int{35} }

type PlacementPreference struct {
	// Types that are valid to be assigned to Preference:
	//	*PlacementPreference_Spread
	//	*PlacementPreference_Image
...
type PlacementPreference_Image struct {
	Image *ImageDependency `protobuf:"bytes,2,opt,name=image,oneof"`
}

func (*PlacementPreference_Spread) isPlacementPreference_Preference() {}
func (*PlacementPreference_Image) isPlacementPreference_Preference()  {}
...
func (m *PlacementPreference) GetImage() *ImageDependency {
	if x, ok := m.GetPreference().(*PlacementPreference_Image); ok {
		return x.Image
	}
	return nil
}
...
func _PlacementPreference_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *PlacementPreference_Image:
...
func _PlacementPreference_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // Preference.spread
		...
		return true, err
	case 2: // Preference.image
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ImageDependency)
		err := b.DecodeMessage(msg)
		m.Preference = &PlacementPreference_Image{msg}
		return true, err
	default:
		return false, nil
	}
...
func init() {
	...
	proto.RegisterType((*ImageDependency)(nil), "docker.swarmkit.v1.ImageDependency")
...
func (m *ImageDependency) Copy() *ImageDependency {
	if m == nil {
		return nil
	}
	o := &ImageDependency{}
...
func (m *ImageDependency) CopyFrom(src interface{}) {

	o := src.(*ImageDependency)
	*m = *o
}
	...
	*m = *o
	if o.Preference != nil {
		...
		case *PlacementPreference_Spread:
			...
			m.Preference = &v
		case *PlacementPreference_Image:
			v := PlacementPreference_Image{
				Image: &ImageDependency{},
			}
			github_com_docker_swarmkit_api_deepcopy.Copy(v.Image, o.GetImage())
			m.Preference = &v
		}
	}
...
func (m *ImageDependency) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ImageDependency) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.ReplicaDescriptor != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintTypes(dAtA, i, uint64(m.ReplicaDescriptor))
	}
	return i, nil
}
...
func (m *PlacementPreference_Image) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.Image != nil {
		dAtA[i] = 0x12
		i++
...
func (m *ImageDependency) Size() (n int) {
	var l int
	_ = l
	if m.ReplicaDescriptor != 0 {
		n += 1 + sovTypes(uint64(m.ReplicaDescriptor))
	}
	return n
}
...
func (m *PlacementPreference_Image) Size() (n int) {
	var l int
	_ = l
	if m.Image != nil {
		l = m.Image.Size()
...
func (this *ImageDependency) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ImageDependency{`,
		`ReplicaDescriptor:` + fmt.Sprintf("%v", this.ReplicaDescriptor) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *PlacementPreference_Image) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&PlacementPreference_Image{`,
		`Image:` + strings.Replace(fmt.Sprintf("%v", this.Image), "ImageDependency", "ImageDependency", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ImageDependency) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ImageDependency: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ImageDependency: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReplicaDescriptor", wireType)
			}
			m.ReplicaDescriptor = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReplicaDescriptor |= (uint64(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *PlacementPreference) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Preference = &PlacementPreference_Image{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
var fileDescriptorTypes = []byte{
	...
	,
}
