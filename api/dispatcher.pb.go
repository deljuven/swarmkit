...
type RootFSSyncRequest struct {
	SessionID string   `protobuf:"bytes,1,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
	Appends   []string `protobuf:"bytes,2,rep,name=appends" json:"appends,omitempty"`
	Removals  []string `protobuf:"bytes,3,rep,name=removals" json:"removals,omitempty"`
}

func (m *RootFSSyncRequest) Reset()                    { *m = RootFSSyncRequest{} }
func (*RootFSSyncRequest) ProtoMessage()               {}
func (*RootFSSyncRequest) Descriptor() ([]byte, []int) { return fileDescriptorDispatcher, []int{12} }

type RootFSSyncMessage struct {
}

func (m *RootFSSyncMessage) Reset()                    { *m = RootFSSyncMessage{} }
func (*RootFSSyncMessage) ProtoMessage()               {}
func (*RootFSSyncMessage) Descriptor() ([]byte, []int) { return fileDescriptorDispatcher, []int{13} }
...
func init() {
	...
	proto.RegisterType((*RootFSSyncRequest)(nil), "docker.swarmkit.v1.RootFSSyncRequest")
	proto.RegisterType((*RootFSSyncMessage)(nil), "docker.swarmkit.v1.RootFSSyncMessage")
...
func (p *authenticatedWrapperDispatcherServer) RootFSSync(ctx context.Context, r *RootFSSyncRequest) (*RootFSSyncMessage, error) {

	if err := p.authorize(ctx, []string{"swarm-worker", "swarm-manager"}); err != nil {
		return nil, err
	}
	return p.local.RootFSSync(ctx, r)
}
...
func (m *RootFSSyncRequest) Copy() *RootFSSyncRequest {
	if m == nil {
		return nil
	}
	o := &RootFSSyncRequest{}
...
func (m *RootFSSyncRequest) CopyFrom(src interface{}) {

	o := src.(*RootFSSyncRequest)
	*m = *o
	if o.Appends != nil {
		m.Appends = make([]string, len(o.Appends))
		copy(m.Appends, o.Appends)
	}

	if o.Removals != nil {
		m.Removals = make([]string, len(o.Removals))
		copy(m.Removals, o.Removals)
	}

}

func (m *RootFSSyncMessage) Copy() *RootFSSyncMessage {
	if m == nil {
		return nil
	}
	o := &RootFSSyncMessage{}
...
func (m *RootFSSyncMessage) CopyFrom(src interface{}) {}
...
type DispatcherClient interface {
	...
	// RootFSSync sync rootfs of the node to manager
	RootFSSync(ctx context.Context, in *RootFSSyncRequest, opts ...grpc.CallOption) (*RootFSSyncMessage, error)
}
...
func (c *dispatcherClient) RootFSSync(ctx context.Context, in *RootFSSyncRequest, opts ...grpc.CallOption) (*RootFSSyncMessage, error) {
	out := new(RootFSSyncMessage)
	err := grpc.Invoke(ctx, "/docker.swarmkit.v1.Dispatcher/RootFSSync", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DispatcherServer interface {
	...
	// RootFSSync sync rootfs of the node to manager
	RootFSSync(context.Context, *RootFSSyncRequest) (*RootFSSyncMessage, error)
}
...
func _Dispatcher_RootFSSync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RootFSSyncRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DispatcherServer).RootFSSync(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/docker.swarmkit.v1.Dispatcher/RootFSSync",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DispatcherServer).RootFSSync(ctx, req.(*RootFSSyncRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Dispatcher_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RootFSSync",
			Handler:    _Dispatcher_RootFSSync_Handler,
		},
	},
...
func (m *RootFSSyncRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RootFSSyncRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *RootFSSyncMessage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RootFSSyncMessage) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (p *raftProxyDispatcherServer) RootFSSync(ctx context.Context, r *RootFSSyncRequest) (*RootFSSyncMessage, error) {
	...
	resp, err := NewDispatcherClient(conn).RootFSSync(modCtx, r)
	if err != nil {
		if !strings.Contains(err.Error(), "is closing") && !strings.Contains(err.Error(), "the connection is unavailable") && !strings.Contains(err.Error(), "connection error") {
			return resp, err
		}
		...
		return NewDispatcherClient(conn).RootFSSync(modCtx, r)
	}
	return resp, err
}
...
func (m *RootFSSyncRequest) Size() (n int) {
	var l int
	_ = l
	l = len(m.SessionID)
	if l > 0 {
...
func (m *RootFSSyncMessage) Size() (n int) {
	var l int
	_ = l
	return n
}
...
func (this *RootFSSyncRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&RootFSSyncRequest{`,
		`SessionID:` + fmt.Sprintf("%v", this.SessionID) + `,`,
		`Appends:` + fmt.Sprintf("%v", this.Appends) + `,`,
		`Removals:` + fmt.Sprintf("%v", this.Removals) + `,`,
		`}`,
	}, "")
	return s
}
func (this *RootFSSyncMessage) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&RootFSSyncMessage{`,
		`}`,
	}, "")
	return s
}
...
func (m *RootFSSyncRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RootFSSyncRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RootFSSyncRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Appends = append(m.Appends, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			m.Removals = append(m.Removals, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipDispatcher(dAtA[iNdEx:])
...
func (m *RootFSSyncMessage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RootFSSyncMessage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RootFSSyncMessage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
var fileDescriptorDispatcher = []byte{
	...
	,
}
